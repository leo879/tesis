class OutflowsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @outflow.save
        format.html { redirect_to @outflow, notice: 'Se ha guardado exitosamente!' }
  ...
  def update
    respond_to do |format|
      if @outflow.update(outflow_params)
        format.html { redirect_to @outflow, notice: 'Se ha editado exitosamente!' }
  ...
  def destroy
    @outflow.destroy
    respond_to do |format|
      format.html { redirect_to outflows_url, notice: 'Se ha eliminado exitosamente!' }
  ...
  private
    ...
    def outflow_params
      params.require(:outflow).permit(:feha, :concepto, :nit, :entidad, :numero_factura, :valor)
    end
end
